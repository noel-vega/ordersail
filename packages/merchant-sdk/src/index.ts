...
import { ApiError, unwrap, type DoFn } from "./http.js";
...
export class AdminClient {
  ...
  private async do<T>(
    ...
    // 403 is always the PermissionsGuard denying a missing permission — never a
    // "normal" empty result — so surface it as an ApiError for reads too (they
    // otherwise return undefined data silently).
