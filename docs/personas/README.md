...
- [Merchant Staff](./merchant-staff.md) — account-defined custom roles built from the 30-key permission catalog. Runs the day-to-day: fulfillment, support, catalog upkeep.
