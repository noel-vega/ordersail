...
// with OS-470, mfaEnrollmentSatisfied with OS-473). Past a handful of
// positionals with adjacent booleans, a transposed argument type-checks
// cleanly and silently mints a wrong auth claim.
