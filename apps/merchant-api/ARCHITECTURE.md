...
|---|---|---|---|
| **identity** | `identity/` | auth, emailed-links, users, roles, permissions, api-keys, account | `accounts`, `users`, `user_invites`, `user_password_resets`, `user_email_verifications`, `account_api_keys`, `roles`, `permissions`, `role_permissions`, `user_roles`, `user_passkeys`, `webauthn_challenges` |
